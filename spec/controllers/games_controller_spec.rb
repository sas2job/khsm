...
RSpec.describe GamesController, type: :controller do
  ...
  # группа тестов для незалогиненного пользователя (Анонимус)
  context 'Anon' do
  ...
  # группа тестов на экшены контроллера, доступных залогиненным пользователям
  context 'Usual user' do
    # перед каждым тестом в группе
    before(:each) { sign_in user } # логиним пользователя user с помощью спец. Devise метода sign_in
